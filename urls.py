"""social_engineering_in_cyber_security URL Configuration
...
from social_engineering_in_cyber_security import settings
...
urlpatterns = [
    ...
    url(r'^Predict_cyber_security_attack_prediction/$', remoteuser.Predict_cyber_security_attack_prediction, name="Predict_cyber_security_attack_prediction"),
    ...
    url(r'^View_Cyber_Security_Attack_Prediction_Ratio/$', serviceprovider.View_Cyber_Security_Attack_Prediction_Ratio, name="View_Cyber_Security_Attack_Prediction_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_cyber_security_attack_prediction_Type/$', serviceprovider.View_cyber_security_attack_prediction_Type, name="View_cyber_security_attack_prediction_Type"),
