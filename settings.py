...
ROOT_URLCONF = 'social_engineering_in_cyber_security.urls'
...
WSGI_APPLICATION = 'social_engineering_in_cyber_security.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'social_engineering_in_cyber_security',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
